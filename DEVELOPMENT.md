...
```bash
git remote add encore encore://vionyx-premium-whatsapp-bot-platform-i4a2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/vionyx-premium-whatsapp-bot-platform-i4a2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/vionyx-premium-whatsapp-bot-platform-i4a2/settings/integrations/github)
